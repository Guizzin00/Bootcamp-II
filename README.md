...
3. Configure o Banco de Dados (Supabase):
   ...
   - Adicione suas credenciais `SUPABASE_URL` e `SUPABASE_KEY` no arquivo `.env`.
   - No SQL Editor do Supabase, crie a tabela rodando:
     ```sql
     create table tasks (
...
## 👨‍💻 Equipe
- Guilherme Oliveira Ribeiro Soares (Matrícula: 22452084)
